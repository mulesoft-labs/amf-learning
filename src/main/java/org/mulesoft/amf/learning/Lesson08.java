...
public class Lesson08 {
    public static void main(String[] args) {
        try {
            ...
            URL dialectResource = ClassLoader.getSystemResource("dialect/instagram_dialect.raml");
            URL dataResource = ClassLoader.getSystemResource("examples/instagram.raml");
